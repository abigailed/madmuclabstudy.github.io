...
document.addEventListener('DOMContentLoaded' , function() {
  ...
  window.onbeforeunload = function () {
    ...
    const jsonData = [{
      ...
      "reviewDescription": "It's a good size and kept my water cold all day in Morocco. It didn't leak, even when tipped over or swinging from the clip on my knapsack. I also like the different lid options."
    },
    {
      "ratingScore": 5,
      "reviewTitle": "really good water bottle",
      "reviewDescription": "i was looking for a water bottle that was big and metal! i didn't want it to be too big to carry or too small to frequently fill up all the time. this is a 32oz bottle and suits my needs perfectly! i love the straw sippy cap (it comes with multiple different caps) i can take it to the gym or out walking. it's like my new best friend bc i take it everywhere i go lol, and it's super cute! i def recommend this one if you're looking at reviews for diff water bottles however!! it's hand wash only! it is easy to clean, but its something to keep in mind"
    }]
  ...
  jsonData.forEach(item => {
    ...
    const clickText6 = document.getElementById("con3");
      ...
      function highlight_review_four() {
        ...
        allReviews.forEach(el => {
          if (el.innerText.includes("hand wash")) {
            el.style.backgroundColor = "yellow";
            el.scrollIntoView({ behavior: "smooth", block: "center" });
          }
          else{
      ...
      function highlight_review_five() {
        ...
        allReviews.forEach(el => {
          if (el.innerText.includes("32 oz")) {
            el.style.backgroundColor = "yellow";
            el.scrollIntoView({ behavior: "smooth", block: "center" });
          }
          else{
