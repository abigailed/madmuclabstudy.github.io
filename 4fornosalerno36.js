...
document.addEventListener('DOMContentLoaded' , function() {
  ...
  window.onbeforeunload = function () {
    ...
    const jsonData = [{
      "ratingScore": 5,
      "reviewTitle": "they stand behind there's product",
      "reviewDescription": "after purchase the serves was great , cold water stopped working The technician diagnosed on premises the location of cold water tube ,to close to the ice box allowing it to freeze . manufacture sent a new door and had it replaced"
    },
    {
      "ratingScore": 5,
      "reviewTitle": "GREAT CUSTOMER SERVICE!",
      "reviewDescription": "I want to thank Chris from Forno. Great customer service and responsiveness. I would happily purchase Forno products again!"
    }]
    ...
    const clickText6 = document.getElementById("con3");
      ...
      function highlight_review_one() {
        ...
        allReviews.forEach(el => {
          if (el.innerText.includes("responsive")) {
      ...
      function highlight_review_two() {
        ...
        allReviews.forEach(el => {
          if (el.innerText.includes("parts")) {
            el.style.backgroundColor = "yellow";
            el.scrollIntoView({ behavior: "smooth", block: "center" });
          }
          else{
      ...
      function highlight_review_four() {
        ...
        allReviews.forEach(el => {
          if (el.innerText.includes("ice box")) {
            el.style.backgroundColor = "yellow";
            el.scrollIntoView({ behavior: "smooth", block: "center" });
          }
          else{
